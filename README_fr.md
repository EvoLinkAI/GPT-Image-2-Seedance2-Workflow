...
- **1er mai 2026 :** ajout des cas 13-27 (grille de sequences de danse, animation de page de bande dessinee, publicite de luxe, video culinaire cinematographique, pipeline d'interface de jeu, workflow d'agent unique, controle des couts via storyboard, MV avec shotlist Claude, grille de casting, pipeline sculpt 3D, remake cyberpunk d'une IP, concept de ville GTA, choregraphie K-Pop, publicite video produit, animation d'introduction de personnage)
- **25 avril 2026 :** ajout des cas 10-12 (storyboard multiframe, toolchain de clip japonais, Claude Code x fiche personnage), cas 9 etendu avec une variante de simulation ARPG, showcase communautaire ajoute a la galerie
- **23 avril 2026 :** lancement du depot avec 9 cas de workflow selectionnes
...
Un aperçu des derniers travaux **GPT Image 2 × Seedance 2.0** partagés par les créateurs sur X (29 avril – 2 mai 2026). Cliquez sur une vidéo pour la lire ; cliquez sur un identifiant d'auteur pour ouvrir le post original. Classé par nombre de vues au moment de la collecte ; une entrée par auteur.
...
**Blocage de moderation de contenu Seedance**

Cause : l'image contient du contenu signale comme sensible (violence realiste, visages humains dans certaines poses).
Solution : passez au style anime ou illustration, ou supprimez les descriptions de figures humaines de votre prompt.

**Le mouvement en sortie est chaotique**

Cause : l'image de storyboard est trop complexe — Seedance ne peut pas determiner la direction de mouvement principale.
Solution : simplifiez le panneau de storyboard a un sujet principal et une action claire. Reduisez les elements d'arriere-plan.

**L'image produit se deforme**

Voir le Guide de coherence → section Coherence des images produit ci-dessus.

**Exigences de format d'entree par plateforme**

| Plateforme | Taille d'entree recommandee | Formats supportes | Taille max |
| :---: | :---: | :---: | :---: |
| Hailuo | 1280x720 ou 720x1280 | JPG / PNG | 10 Mo |
| Higgsfield | 1920x1080 | PNG | 20 Mo |
| HitPaw | Tout ratio | JPG / PNG / WEBP | 15 Mo |
